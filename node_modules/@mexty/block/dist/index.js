...
const Block = ({ blockId, props: blockProps, onLoad, onError, fallback, className, style, validateProps = false, dataMextyId }) => {
    ...
    if (isLoading) {
        return (jsxRuntime.jsx("div", { className: className, style: Object.assign({ width: '100%', height: '100%' }, style), "data-mexty-id": dataMextyId, children: fallback || (jsxRuntime.jsxs("div", { style: {
                    ...
                    height: '100%',
                    width: '100%'
                }, children: [jsxRuntime.jsx("div", { style: { marginRight: '0.5rem' }, children: "\u23F3" }), "Loading block ", blockId, "..."] })) }));
    }
    // Render error state
    if (error) {
        return (jsxRuntime.jsx("div", { className: className, style: Object.assign({ width: '100%', height: '100%' }, style), "data-mexty-id": dataMextyId, children: jsxRuntime.jsxs("div", { style: {
                    ...
                    color: '#dc2626'
                }, children: [jsxRuntime.jsx("div", { style: { fontWeight: 'bold', marginBottom: '0.5rem' }, children: "\u274C Failed to load block" }), jsxRuntime.jsxs("div", { style: { fontSize: '0.875rem' }, children: ["Block ID: ", blockId] }), jsxRuntime.jsxs("div", { style: { fontSize: '0.875rem', marginTop: '0.25rem' }, children: ["Error: ", error.message] })] }) }));
    }
...
function createNamedBlock(componentName, options = {}) {
    const NamedBlockComponent = (componentProps) => {
        ...
        if (isLoading) {
            return (jsxRuntime.jsx("div", { className: componentProps.className, style: componentProps.style, children: componentProps.fallback || (jsxRuntime.jsxs("div", { style: {
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        padding: '2rem',
                        color: '#666'
                    }, children: [jsxRuntime.jsx("div", { style: { marginRight: '0.5rem' }, children: "\uD83D\uDD0D" }), "Resolving component ", componentName, "..."] })) }));
        }
        // Show error if component name couldn't be resolved
        if (error || !blockId) {
            return (jsxRuntime.jsx("div", { className: componentProps.className, style: componentProps.style, children: jsxRuntime.jsxs("div", { style: {
                        padding: '1rem',
                        border: '1px solid #fee',
                        borderRadius: '4px',
                        backgroundColor: '#fef2f2',
...
const AuthorBlock = (_a) => {
    ...
    if (loading) {
        return (jsxRuntime.jsxs("div", { className: "mext-block-loading", style: {
                padding: '20px',
                textAlign: 'center',
                border: '1px dashed #ccc',
                borderRadius: '4px',
                color: '#666'
            }, children: [jsxRuntime.jsxs("div", { children: ["Loading ", author, "/", component, "..."] }), jsxRuntime.jsx("div", { style: { fontSize: '12px', marginTop: '8px' }, children: "Fetching federated component" })] }));
    }
    if (error) {
        return (jsxRuntime.jsxs("div", { className: "mext-block-error", style: {
                padding: '20px',
                textAlign: 'center',
                ...
                color: '#d63031'
            }, children: [jsxRuntime.jsx("div", { children: jsxRuntime.jsxs("strong", { children: ["Error loading ", author, "/", component] }) }), jsxRuntime.jsx("div", { style: { fontSize: '12px', marginTop: '8px' }, children: error }), jsxRuntime.jsx("div", { style: { fontSize: '11px', marginTop: '8px', color: '#666' }, children: "Make sure the component exists and is published" })] }));
    }
    if (!BlockComponent) {
        return (jsxRuntime.jsxs("div", { className: "mext-block-not-found", style: {
                padding: '20px',
                textAlign: 'center',
                ...
                color: '#f57c00'
            }, children: [jsxRuntime.jsxs("div", { children: ["Component ", author, "/", component, " not available"] }), jsxRuntime.jsx("div", { style: { fontSize: '12px', marginTop: '8px' }, children: "The component may not be built or published yet" })] }));
    }
    return (jsxRuntime.jsx(react.Suspense, { fallback: jsxRuntime.jsxs("div", { className: "mext-block-suspense", style: {
                padding: '20px',
                textAlign: 'center',
                color: '#666'
...
exports.AuthorBlock = AuthorBlock;
exports.Block = Block;
exports.Chart = Chart;
...
exports.VirtualGame = VirtualGame;
exports.blockRegistry = blockRegistry;
exports.configure = configure;
exports.createAuthorBlock = createAuthorBlock;
exports.createAuthorNamespace = createAuthorNamespace;
exports.createNamedBlock = createNamedBlock;
exports.createRegistryEntry = createRegistryEntry;
exports.createTypedBlock = createTypedBlock;
exports.default = MextBlock;
exports.federationLoader = federationLoader;
exports.withBlockMetadata = withBlockMetadata;
