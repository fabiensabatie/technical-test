...
const Block = ({ blockId, props: blockProps, onLoad, onError, fallback, className, style, validateProps = false, dataMextyId }) => {
    ...
    const [validatedProps, setValidatedProps] = useState(blockProps);
    // Validate props against schema
    const validatePropsAgainstSchema = useCallback((props, schema) => {
    ...
    if (isLoading) {
        return (jsx("div", { className: className, style: Object.assign({ width: '100%', height: '100%' }, style), "data-mexty-id": dataMextyId, children: fallback || (jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
    ...
    // Render error state
    if (error) {
        return (jsx("div", { className: className, style: Object.assign({ width: '100%', height: '100%' }, style), "data-mexty-id": dataMextyId, children: jsxs("div", { style: {
                    padding: '1rem',
    ...
    if (MountedComponent) {
        return (jsx("div", { className: className, style: Object.assign({ width: '100%', height: '100%' }, style), "data-mexty-id": dataMextyId, children: jsx(MountedComponent, {}) }));
    }
    return null;
};
...
function createTypedBlock(componentName, options = {}) {
    const TypedBlockComponent = (componentProps) => {
        ...
        return (jsx(NamedBlock, Object.assign({}, componentProps, { props: mergedProps })));
    };
...
const AuthorBlock = (_a) => {
    ...
    return (jsx(Suspense, { fallback: jsxs("div", { className: "mext-block-suspense", style: {
                ...
                textAlign: 'center',
                color: '#666'
            }, children: ["Initializing ", author, "/", component, "..."] }), children: jsxs("div", { className: "mext-author-block", "data-author": author, "data-component": component, children: [jsx(BlockComponent, Object.assign({}, props)), metadata && (jsx("div", { className: "mext-block-metadata", style: { display: 'none' }, children: JSON.stringify(metadata) }))] }) }));
};
/**
 * Create a typed author block component
 */
function createAuthorBlock(author, component) {
    const AuthorBlockComponent = (props) => (jsx(AuthorBlock, Object.assign({ author: author, component: component }, props)));
